    ...
    translation: {
      ...
      statusPage: {
        ...
        tips: [
          ...
          "Votre base Redis dédiée garantit des performances optimales.",
          "La mise en place complète prend en moyenne 3 à 5 minutes.",
          ...
          "Votre CRM tourne dans un espace dédié et sécurisé.",
    ...
    translation: {
      ...
      statusPage: {
        ...
        tips: [
          ...
          "Your dedicated Redis cache ensures optimal performance.",
          "Full setup takes an average of 3 to 5 minutes.",
          "Your data is hosted in West Africa for minimal latency.",
          "You will receive full administrator access to your Fereloo CRM.",
          "Your CRM runs in a dedicated and secure space.",
    ...
    translation: {
      ...
      statusPage: {
        ...
        tips: [
          ...
          "Ihr dedizierter Redis-Cache gewährleistet optimale Leistung.",
          "Die vollständige Einrichtung dauert durchschnittlich 3 bis 5 Minuten.",
          ...
          "Ihr CRM läuft in einem eigenen, sicheren Bereich.",
